...
function App () {
  ...
  const handleAddTodo = () => {
    ...
    // After adding the todo, clear the input fields
    setNewTitle ('');
    setNewDescription ('');
  };
              ...
              return (
                <div className="todo-list-item" key={index}>
                  ...
                  <div>
                    <AiOutlineDelete
                      className="icon"
                      // TODO: Implement delete functionality after alert
                      onClick={() => {
                        // const confirm = alert("Are you sure you want to delete this item?");
